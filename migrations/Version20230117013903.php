 ...
 */
final class Version20230117013903 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE agencia ADD gerente_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE conta ADD user_id INT DEFAULT NULL');
